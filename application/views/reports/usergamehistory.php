  ...
  <div class="RightWrap">
    <div class="content_wrap">
      ...
      <?php if(isset($_REQUEST['errmsg'])){
        ...
        <form action="<?php echo base_url(); ?>reports/game/user?rid=21" method="post" name="tsearchform" id="tsearchform"  >
        ...
        <td><form action="<?php echo base_url();?>reports/game/user?rid=21" method="post" name="clrform" id="clrform">
	...
	//$resvalue['HANDID']='<a href="'.base_url().'reports/game/gameHandIdDetails/'.$results[$i]->INTERNAL_REFERENCE_NO.'?rid=21">'.$results[$i]->INTERNAL_REFERENCE_NO.'</a>';
        $refno = $results[$i]->INTERNAL_REFERENCE_NO;   
        if(substr($refno, 0, 3) == AAB){
        $resvalue['HANDID'] = '<a href="#" onclick="NewWindow1(\''.base_url().'reports/game/gameHandIdDetails/'.$results[$i]->INTERNAL_REFERENCE_NO.'?rid=21\',\'Game Trans\',\'1344\',\'900\',\'yes\')"><strong>'.$results[$i]->INTERNAL_REFERENCE_NO.'</strong></a>';    
        } else{
        $resvalue['HANDID'] = '<a href="#" onclick="NewWindow(\''.base_url().'reports/game/gameHandIdDetails/'.$results[$i]->INTERNAL_REFERENCE_NO.'?rid=21\',\'Game Trans\',\'924\',\'900\',\'yes\')"><strong>'.$results[$i]->INTERNAL_REFERENCE_NO.'</strong></a>';            
        }
	...
	$resvalue['TIMESTAMP'] = date("d/m/Y h:i:s",strtotime($results[$i]->TRANSACTION_DATE));
   ...
   <p class="searchWrap1" style="height:30px;">
    ...
    <b> Total Records: <font color="#FF3300">(<?php echo $tot_users; ?>) </font></b> &nbsp;&nbsp;&nbsp;
            ...
            <script type="text/javascript">
                jQuery("#list4").jqGrid({
                    ...
                    colModel:[
						...
						{name:'STARTWORTH',index:'STARTWORTH', align:"right", width:50},
						...
						{name:'ENDWORTH',index:'ENDWORTH', align:"right", width:40},
