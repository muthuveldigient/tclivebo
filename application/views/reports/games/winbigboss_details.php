...
<?php
 $info = $this->game_model->getWinBigBossSumDetails($handId);  
?>
<div class="tableWrap">
	...
	$results1 = $this->game_model->getWinBigBossGameDetails($handId);  
	foreach($results1 as $row1){
		$gameList[$row1->GAMES_ID]['GAMES_NAME'] = $row1->GAMES_NAME;
		$gameList[$row1->GAMES_ID]['DESCRIPTION'] = $row1->DESCRIPTION;
	}
	$results = $this->game_model->getWinBigBossPlayDetails($handId);  
 $i=1;
