...
<script>
function mobTripleChanceTimerWindow(gameName,groupId){
  ...
  <div class="Agent_Game_Det_wrap">
    <div class="Agent_game_Left" style="width:300px;">
      <div class="Agent_game_tit_wrap" style="width:260px;">
        ...
        <div class="Agent_game_val" style="width:135px">:
			 <?php 
		  if($gamename=="triplechancetimer"){ 
		    echo ucfirst(strtolower($gameName)); 
		  }else if($gamename=="mobtriplechancetimer"){ 
		    echo "Mobile Triple Chance Timer"; 
		  }else{ 
		    echo ucfirst(wintriplechancetimer);
		  }?>
		<?php //echo ucfirst(strtolower($gameName)); ?></div>
      </div>
    </div>
...
<?PHP  $results = $this->game_model->getmobTripleChanceTimerPlayDetails($handId,$get);  ?>
      <tr>
        ...
        <td class="<?PHP if ($i%2=="0") { ?>NSTb2HdrWrap <?PHP } else { ?> NSTblHdrWrap <?PHP } ?>"><table width="100%" align="center" class="NSTblHdrTxt">
            ...
            <tr>
			  ...
			  <!--<a href="#" onclick="mobTripleChanceTimerWindow('<?php //echo $gameName; ?>','<?php //echo $results[0]->PLAY_GROUP_ID; ?>')"><?php //echo $results[0]->PLAY_GROUP_ID; ?></a>-->
			  <td>
            </tr>
          </table></td>
        <td class="<?PHP if ($i%2=="0") { ?>NSTb2HdrWrap <?PHP } else { ?> NSTblHdrWrap <?PHP } ?>"><table width="100%" align="center" class="NSTblHdrTxt">
