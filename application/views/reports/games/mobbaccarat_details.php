...
<div class="tableWrap">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <?PHP  $results = $this->game_model->getMobBaccaratDetails($handId);  ?>
    <tr>
	...
	$playercardtot=$total['baccaratResult']['playerCardTotal'];
	$bankercardtot=$total['baccaratResult']['bankerCardTotal'];
	if($total['baccaratResult']['playerCards']){
		$totusercards=$total['baccaratResult']['playerCards'];
	?>
			 ...
			 <table>
				<tr>
				   <?php
					  ...
					  { 
						  $cardname=$totusercards[$uc]['card'];
						  $cardval=$totusercards[$uc]['cardValue'];
						  ?>
				...
				<tr>
				   <td><strong><?php echo $total['baccaratResult']['playerCardTotal'];?></strong></td>
				</tr>
			 </table>
		  </td>
	   </tr>
	...
	<?php } ?>	  
	<?php
   	if($total['baccaratResult']['bankerCards']) {
		$totdealercards=$total['baccaratResult']['bankerCards'];  
   	?>
	<br/>
	   ...
	   <table cellpadding="2" cellspacing="2" >
		  <tr>
			 <?php 
				...
				{ 
					$cardname1=$totdealercards[$dc]['card'];
					$cardval1=$totdealercards[$dc]['cardValue'];
					?>
		  ...
		  <tr>
			 <td><strong><?php echo $total['baccaratResult']['bankerCardTotal'];?></strong></td>
		  </tr>
	   </table>
	</div>
	<?php }?>	
