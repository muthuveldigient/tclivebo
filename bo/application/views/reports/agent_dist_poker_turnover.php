...
<?php	$distresults=$dresults['dist_result'];
		...
		if(count($distagntresults)>0 && is_array($distagntresults)){
        	for($l=0;$l<count($distagntresults);$l++){
				...
				$resvalue['RAKE2'] =  $distagntresults[$l]->totrake;
	...
	if(isset($arrs) && $arrs!=''){
		if($partnertype==11 || $partnertype==0 || $partnertype==15){	 ?>
<style>
...
jQuery("#listsg11").jqGrid({
   	url:'<?php echo base_url();?>reports/ajax/distpokerreport/<?php echo $distid;?>?q=1&START_DATE_TIME='+"<?php echo date("Y-m-d H:i:s",strtotime($START_DATE_TIME)); ?>"+'&END_DATE_TIME='+"<?php echo date("Y-m-d H:i:s",strtotime($END_DATE_TIME)); ?>"+'&keyword=Search',
	datatype: "xml",
	height: '100%',
	width: 1002,
...
jQuery("#listsg12").jqGrid({
   	url:'<?php echo base_url();?>reports/ajax/poker_subdistreport/<?php echo $distid;?>?q=1&START_DATE_TIME='+"<?php echo date("Y-m-d H:i:s",strtotime($START_DATE_TIME)); ?>"+'&END_DATE_TIME='+"<?php echo date("Y-m-d H:i:s",strtotime($END_DATE_TIME)); ?>"+'&keyword=Search',
	datatype: "xml",
	height: '100%',
	width: 1002,
   	colNames:['Partner Name','Play Points', 'Win Points','Player Loss', 'Total Rake','Agent Rake','Company'],
...
jQuery("#listsg13").jqGrid({
   	url:'<?php echo base_url();?>reports/ajax/poker_agent_report/<?php echo $distid;?>?q=1&START_DATE_TIME='+"<?php echo date("Y-m-d H:i:s",strtotime($START_DATE_TIME)); ?>"+'&END_DATE_TIME='+"<?php echo date("Y-m-d H:i:s",strtotime($END_DATE_TIME)); ?>"+'&keyword=Search',
	datatype: "xml",
	height: '100%',
	width: 1002,
   	colNames:['Partner Name','Play Points', 'Win Points','Player Loss', 'Total Rake','Agent Rake','Company'],
