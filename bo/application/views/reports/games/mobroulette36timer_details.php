...
<?PHP  $results = $this->game_model->getmobroulette36TimerPlayDetails($handId);  ?>
      <tr>
        ...
        <td class="<?PHP if ($i%2=="0") { ?>NSTb2HdrWrap <?PHP } else { ?> NSTblHdrWrap <?PHP } ?>"><table width="100%" align="center" class="NSTblHdrTxt">
          ...
          <td class="<?PHP if ($i%2=="0") { ?>NSTb2HdrWrap <?PHP } else { ?> NSTblHdrWrap <?PHP } ?>"><table width="100%" align="center" class="NSTblHdrTxt">
            <tr>
              <td><a href="#" onclick="mobRoulette36TimerWindow('<?php echo $gameName; ?>','<?php echo $results[0]->PLAY_GROUP_ID; ?>')"><?php echo $results[0]->PLAY_GROUP_ID; ?></a><td>
            </tr>
          </table></td>
        <td class="<?PHP if ($i%2=="0") { ?>NSTb2HdrWrap <?PHP } else { ?> NSTblHdrWrap <?PHP } ?>"><table width="100%" align="center" class="NSTblHdrTxt">
            <tr>
