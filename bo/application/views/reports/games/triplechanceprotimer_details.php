...
<?PHP  $results = $this->game_model->getTripleChanceTimerPlayDetails($handId,$gameName);  ?>
      <tr>
        ...
        <td class="<?PHP if ($i%2=="0") { ?>NSTb2HdrWrap <?PHP } else { ?> NSTblHdrWrap <?PHP } ?>"><table width="100%" align="center" class="NSTblHdrTxt">
            ...
            <tr>
              <td>
				<!--<a href="#" onclick="tripleChanceTimerWindow('<?php echo $gameName; ?>','<?php //echo $results[0]->PLAY_GROUP_ID; ?>')"><?php //echo $results[0]->PLAY_GROUP_ID; ?></a>-->
				<?php echo $results[0]->PLAY_GROUP_ID; ?>
				<td>
            </tr>
          </table></td>
        <td class="<?PHP if ($i%2=="0") { ?>NSTb2HdrWrap <?PHP } else { ?> NSTblHdrWrap <?PHP } ?>"><table width="100%" align="center" class="NSTblHdrTxt">
...
<?php  
    ...
    if($tot['tripleChanceResult']['wheel']['singleWheelNumber']){
	    $sw= $tot['tripleChanceResult']['wheel']['singleWheelNumber'];
    }
	/* if($winmat[$tot['tripleChanceResult']['wheel']['singleWheelNumber']]){
	    $sw= $winmat[$tot['tripleChanceResult']['wheel']['singleWheelNumber']];
    } */
    if($tot['tripleChanceResult']['wheel']['doubleWheelNumber']){
	    $dw= $tot['tripleChanceResult']['wheel']['doubleWheelNumber'];
    }
	if($tot['tripleChanceResult']['wheel']['tripleWheelNumber']){
	    $tw= $tot['tripleChanceResult']['wheel']['tripleWheelNumber'];
    }
	if($tot['tripleChanceResult']['wheel']['tripleWheelNumber']){
	    $draw= $tot['tripleChanceResult']['wheel']['tripleWheelNumber'];
    }
    if($tot['tripleChanceResult']['wheel']['jackpot']){
	    $jackpot= $tot['tripleChanceResult']['wheel']['jackpot'];
    }  
	...
	<div class="TCwrap">
		<div class="TC_infoWrap">
			...
			<div class="TC_infoWinBet">
				...
				<div class="infoTxt"><?php echo (!empty($results[0]->TOTAL_WIN)?$results[0]->TOTAL_WIN:'0');?></div>
			</div>
			<div class="TC_infoWinBet">
			    <div class="infoTxt">Draw No:&nbsp;&nbsp;</div>
				<div class="infoTxt"><?php echo $draw;?></div>
			</div>
			<div class="TC_infoWinBet">
			    <div class="infoTxt">Jackpot:&nbsp;&nbsp;</div>
				<div class="infoTxt"><?php echo (!empty($jackpot)?$jackpot.'X':'N');?></div>
			</div>
			<div class="TC_infoWinBet">
