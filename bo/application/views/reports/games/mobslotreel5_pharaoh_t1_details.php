<script>
var win2 = null;
function NewWindow2(mypage1,myname1,w,h,scroll){
var LeftPosition = (screen.width) ? (screen.width-w)/2 : 0;
var TopPosition = (screen.height) ? (screen.height-h)/2 : 0;
var settings ='height='+h+',width='+w+',top='+TopPosition+',left='+LeftPosition+',scrollbars='+scroll+',resizable';
win2 = window.open(mypage1,myname1,settings);
}
</script>
...
<div class="tableWrap">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <?PHP  $results = $this->game_model->getMobForbittenFortunePlayDetails($handId);  ?>
    <tr>
...
?>
  ...
  <?php
	  $totFreeSpin=json_decode($results[0]->PLAY_DATA, true);
	
	  $is_freespin = $totFreeSpin['spinResult']['canFreeSpin'];
	  if($is_freespin == 1){
	  	 $freeSpinResult = $totFreeSpin['freeSpinResultHistory'];
		...
		?>
         ...
         <?php //echo $freeSpinResult[$fs]["remainingFreeRound"];
		 
		// echo "<br />";
		  ?>
		  		<td style="border: 1px solid; padding: 4px;">
                <a href="javascript::void(0);" style="font-weight:bold;" onclick="NewWindow2('<?php echo base_url(); ?>games/shan/gamedetails/freespinwindow?refno=<?php echo $handId; ?>&spin=<?php echo $fs; ?>','Free Spin Trans','824','700','yes')" href=""><?php echo ($fs+1)."/".$freeSpinResult[$fs]["remainingFreeRound"]; ?></a></td>
		 <?php if($fs == 20){ ?>
			 </tr><tr>
		  <?php
		     }
    ...
    <tr>
                ...
                <div class="UDFieldtitle">
                  ...
                  <div>
                    <?php     
                                       ...
                                       ?>
                    <img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $symbol2.".png"?>" height="65" width="65"/>
                    <?php
							}
						}
                     ?>
      ...
      <td valign="top"><div id="lineImage" style="position:absolute;"></div>
        <table style="margin-top: 10px; border:1px solid #001f87" width="150">
          <tr>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol1; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol2; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol3; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol4; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol5; ?>.png" width="100" height="100"></td>
          </tr>
          <tr>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol6; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol7; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol8; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol9; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol10; ?>.png" width="100" height="100"></td>
          </tr>
          <tr>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol11; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol12; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol13; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol14; ?>.png" width="100" height="100"></td>
            <td><img src="<?php echo base_url(); ?>static/images/minigame/forbittenfortune/<?php echo $windowSymbol15; ?>.png" width="100" height="100"></td>
          </tr>
        </table></td>
    </tr>
  </table>
