...
<div class="tableWrap">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <?PHP  $results = $this->game_model->getMobJungleSafariPlayDetails($handId);  ?>
    <tr>
	  ...
	  if($is_freespin == 1){
		...
		// echo "<br />";
		  ?>
                ...
                <a href="javascript::void(0);" style="font-weight:bold;" onclick="NewWindow2('<?php echo base_url(); ?>games/shan/gamedetails/freespinwindow_mobjunglet2?refno=<?php echo $handId; ?>&spin=<?php echo $fs; ?>','Free Spin Trans','824','700','yes')" href=""><?php echo ($fs+1)."/".$freeSpinResult[$fs]["remainingFreeRound"]; ?></a></td>
		 <?php if($fs == 20){ ?>
			 </tr><tr>
		  <?php
		     }
