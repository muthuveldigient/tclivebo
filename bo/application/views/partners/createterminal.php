    ...
    <div class="content_wrap">
      <div class="tableListWrap">
        ...
        <?php
			...
			echo form_open('partners/partners/createTerminal?rid=55',$attributes);
		?>
		<input type="hidden" name="current_user_session_id" value="<?php echo $this->session->userdata('session_id');?>"  />
        <table width="100%" class="ContentHdr">
          <tr>
            <td><strong>Create Terminal</strong></td>
          </tr>
        </table>
        <?php if($this->session->flashdata('message')=='Terminal created successfully.') { ?>
        ...
        <table width="100%" class="searchWrap" bgcolor="#993366">
          ...
          <tr>
            <td colspan="3"><table width="100%" cellpadding="10" cellspacing="10">
                <tr>
                  <td width="33%" id="newUserName" class="control-group"><span class="TextFieldHdr"> <?php echo form_label('Terminal Name<span class="mandatory">*</span> :', 'Terminalname');?> </span>
                    <?php
                                        $Username = array(
                                              'name'        => 'username',
                                              'id'          => 'username',
    ...
    ?>
        ...
        ?>
                ...
                <tr>
				  ...
				  <td width="33%"><span class="TextFieldHdr"> <?php echo form_label('Printer Option:', 'Printer Option');?> </span>
						<input type="radio" name="PRINTER" value="1" checked> Yes
